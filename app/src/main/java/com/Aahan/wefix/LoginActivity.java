    ...
    private void delearLogin(String txt_email, String txt_password) {
        ...
        call.enqueue(
                new Callback<DelearResponse>() {
                    @Override
                    public void onResponse(@NonNull Call<DelearResponse> call, @NonNull Response<DelearResponse> response) {
...
//                                    Toast.makeText(LoginActivity.this, delear.getTblDelearId() + "lbkjkv", Toast.LENGTH_SHORT).show();
                    ...
                    @Override
                    public void onFailure(@NonNull Call<DelearResponse> call, @NonNull Throwable t) {
